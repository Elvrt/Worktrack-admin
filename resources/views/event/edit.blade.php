    ...
    <div class="overflow-x-auto">
        <div class="inline-block min-w-full align-middle">
            <div class="overflow-hidden shadow">
                ...
                @else
                    <form action="{{ route('event.update', $event->event_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input name="event_date" id="event_date" value="{{ old('event_date', \Carbon\Carbon::parse($event->event_date)->format('M/d/Y')) }}"
                                ...
                                <div class="col-span-6">
                                    ...
                                    <textarea name="information" id="information" rows="4"
                                        ...
                                        placeholder="Provide additional information about the event here">{{ old('information', $event->information) }}</textarea>
                                    @error('information')
                                        <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                                    @enderror
                                </div>
