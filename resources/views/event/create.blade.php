                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="relative">
                                    ...
                                    <input name="event_date" id="event_date" value="{{ old('event_date') }}"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="relative">
                                    ...
                                    <input name="event_time" id="event_time" value="{{ old('event_time') }}" type="time"
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea name="information" id="information" rows="4"
                                    ...
                                    placeholder="Provide additional information about the event here">{{ old('information') }}</textarea>
                                @error('information')
                                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                                @enderror
                            </div>
