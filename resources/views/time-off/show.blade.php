                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-6 gap-6">
                                ...
                                <select name="employee_id" id="employee_id"
                                    ...
                                    @foreach($employees as $employee)
                                        <option value="{{ $employee->employee_id }}"
                                            {{ $timeOff->employee->employee_id == $employee->employee_id ? "selected" : "" }}>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <button type="button" onclick="openModal('{{ $timeOff->letter }}')" class="block w-full text-start text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 p-2.5">
                                    View Letter
                                </button>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="relative">
                                    ...
                                    <input name="start_date" id="start_date" value="{{ \Carbon\Carbon::parse($timeOff->start_date)->format('M/d/Y') }}"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="relative">
                                    ...
                                    <input name="end_date" id="end_date" value="{{ \Carbon\Carbon::parse($timeOff->end_date)->format('M/d/Y') }}"
                                        id="datepicker-orientation" datepicker datepicker-orientation="bottom right"
                                        type="text"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5"
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea name="reason" id="reason" rows="3"
                                    ...
                                    placeholder="Provide additional reasons for time off here" disabled>{{ $timeOff->reason }}</textarea>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
