    ...
    <div class="overflow-x-auto">
        <div class="inline-block min-w-full align-middle">
            <div class="overflow-hidden shadow">
                ...
                @else
                    <form action="{{ route('goal.update', $goal->goal_id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input name="goal_date" id="goal_date" value="{{ old('goal_date', \Carbon\Carbon::parse($goal->goal_date)->format('M/d/Y')) }}"
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="project_title" id="project_title"
                                        value="{{ old('project_title', $goal->project_title) }}"
                                ...
                                <div class="col-span-6">
                                    ...
                                    <textarea name="project_description" id="project_description" rows="3"
                                        ...
                                        placeholder="Enter project description">{{ old('project_description', $goal->project_description) }}</textarea>
                                    @error('project_description')
                                        <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-span-6">
                                    <label for="employee_ids" class="block mb-2 text-sm font-medium text-gray-900">Employee Names</label>
                                    <!-- Selected Employees Display -->
                                    <div id="selectedEmployees" class="mt-2 mb-2">
                                        @foreach($goal->employees as $employee)
                                            <span class="bg-yellow-100 text-yellow-800 text-sm font-medium mr-2 mb-2 px-2.5 py-0.5 rounded inline-block">
                                                {{ $employee->name }}
                                            </span>
                                        @endforeach
                                    </div>
                                            ...
                                            @foreach($employees as $employee)
                                                <div class="flex items-center">
                                                    <input type="checkbox" name="employee_id[]"
                                                        ...
                                                        {{ $goal->employees->contains($employee->employee_id) ? 'checked' : '' }}
                                                        class="employee-checkbox mr-2">
