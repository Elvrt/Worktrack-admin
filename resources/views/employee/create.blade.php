                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="relative">
                                    ...
                                    <input name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth') }}"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select name="role_id" id="role_id"
                                    ...
                                    @foreach($roles as $role)
                                        <option value="{{ $role->role_id }}" {{ old('role_id') == $role->role_id ? "selected" : "" }}>{{ $role->position }}</option>
                                    @endforeach
                                </select>
                                @error('role_id')
                                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="password" name="password_confirm" id="password_confirm"
                                    ...
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5"
                                    placeholder="Enter password confirm" autocomplete="off" required>
