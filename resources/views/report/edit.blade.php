            ...
            <div class="overflow-hidden shadow">
                @empty($report)
                    <div class="flex items-center justify-center p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg"
                        ...
                        <span>The data you are looking for is not nt found</span>
                    </div>
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <textarea name="activity_description" id="activity_description" rows="3"
                                            ...
                                            placeholder="Enter activity description">{{ old('activity_description', $report->activity_description) }}</textarea>
