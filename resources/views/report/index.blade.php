                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($reports as $report)
                            <tr class="hover:bg-gray-100">
                                ...
                                <td
                                    class="p-4 text-base font-medium text-gray-900 whitespace-nowrap overflow-hidden truncate">
                                    {{ \Carbon\Carbon::parse($report->absence->clock_in)->format('h:i A') }}
                                </td>
                                <td
                                    class="p-4 text-base font-medium text-gray-900 whitespace-nowrap overflow-hidden truncate">
                                    {{ \Carbon\Carbon::parse($report->absence->clock_out)->format('h:i A') }}
                                </td>
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    ...
                                    <button type="button" onclick="openModal({{ $report->absence_id }})"
...
@push('js')
    <script>
        function openModal(reportId) {
            document.getElementById('delete-form').action = "{{ route('report.destroy', '') }}/" + reportId;
